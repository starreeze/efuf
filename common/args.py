...
parser.add_argument(
    ...
    type=str,
    default="LLaVA/playground/model/llava-v1.5-7b",
)
parser.add_argument(
    "--llava_path",
    type=str,
...
parser.add_argument(
    "--llava_vit_path",
    type=str,
    default="/home/nfs03/xingsy/huggingface/hub/models--openai--clip-vit-large-patch14-336/snapshots/ce19dc912ca5cd21c8a653c79e251e808ccabcd1",
)
...
parser.add_argument(
    ...
    type=str,
    default="/home/nfs03/zhaof/ShareGPT4V/playground/model/share4v-7b",
)
parser.add_argument(
    "--share4v_path",
    type=str,
...
parser.add_argument(
    "--share4v_vit_path",
    type=str,
    default="/home/nfs02/zhaof/ShareGPT4V/ShareGPT4V-7B_Pretrained_vit-large336-l12",
)
