...
class MplugOwlForConditionalGeneration(MplugOwlPreTrainedModel):
    ...
    def forward(
        ...
        # print(f"modia_token_indices={media_token_indices}")
        ...
        # Forward into GPT
        # print("\nin OWL/model.forward")
        # print(f"inputs_emmeds.shape={input_embeds.shape}")
        # # print(f"attention_mask={attention_mask.shape}")
        # print(f"labels.shape={labels.shape}")
        # print(f"return_di\ct={return_dict}")
        # # print(f"vocab_size={self.config.vocab_size}")
        # print(f"output_attentions={self.config.output_attentions}")
        ...
        # print(f"\nouputs={type(outputs)}")
        # print(f"type(language_model)={type(self.language_model)}")
        ...
        return outputs, labels, loss_mask # add labels from ant
